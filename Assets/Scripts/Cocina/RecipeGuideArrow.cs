...
public class RecipeGuideArrow : MonoBehaviour
{
    ...
    [Header("Aspecto")]
    [SerializeField] private Color _arrowColor = new(1f, 0.55f, 0.1f, 1f);
    ...
    private void Retarget(RecipeData recipe)
    {
        ...
        {
            EspetoMinigame espetera = FindAnyObjectByType<EspetoMinigame>();
    ...
    {
        GameObject go = new("RecipeGuideArrow");
        ...
        Mesh mesh = new() { name = "GuideArrow (procedural)" };

        Vector3[] verts =
        {
            new( 0.00f, 0f,  0.50f), // 0: punta
            new(-0.28f, 0f,  0.08f), // 1: ala izquierda
            new( 0.28f, 0f,  0.08f), // 2: ala derecha
            new(-0.11f, 0f,  0.08f), // 3: hombro izq. del mástil
            new( 0.11f, 0f,  0.08f), // 4: hombro der. del mástil
            new(-0.11f, 0f, -0.45f), // 5: cola izq.
            new( 0.11f, 0f, -0.45f), // 6: cola der.
        };
